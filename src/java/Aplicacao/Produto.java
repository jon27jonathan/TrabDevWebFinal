...
public class Produto {
    ...
    public Produto(int id, String nome_produto, String descricao, double preco_compra, double preco_venda, int quantidade_disponivel, String liberado_venda, int id_categoria) {
        this.id = id;
